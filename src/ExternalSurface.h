...
public:
	...
	virtual bool getSurf(double *surf__volume,bool optimise_grids,bool fill=false,double cav_vol=0);
	...
	virtual void getRayIntersection(double p1[3],double p2[3],
									vector<pair<VERTEX_TYPE,VERTEX_TYPE*>> &intersections,bool computeNormals,int thread_id);
	...
	/** Do nothing*/
	virtual double getSurfaceArea(void);
