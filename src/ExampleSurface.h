...
public:
	...
	virtual void getRayIntersection(double p1[3],double p2[3],vector<pair<double,double*>> &intersections,bool computeNormals,int thread_id);
	#else
	virtual void getRayIntersection(double p1[3],double p2[3],vector<pair<float,float*>> &intersections,bool computeNormals);
	#endif
